...
public class MessageConst {
    public static final String CV_CREATED_SUCCESSFULLY = "CV created successfully";
    public static final String CV_DETAIL_FETCHED_SUCCESSFULLY = "CV fetched successfully";
