package org.workfitai.notificationservice.util;

import org.junit.jupiter.api.AfterEach;
import org.junit.jupiter.api.Test;
import org.slf4j.MDC;
import org.workfitai.notificationservice.constants.LogType;
...
class LogContextTest {
    ...
    void setAction_putsValue_andIgnoresBlank() {
        LogContext.setAction("CREATE_NOTIFICATION");
        assertThat(MDC.get("action")).isEqualTo("CREATE_NOTIFICATION");
    ...
    void setEntityType_putsValue_andIgnoresBlank() {
        LogContext.setEntityType("Notification");
        assertThat(MDC.get("entity_type")).isEqualTo("Notification");
    ...
    void setEntityId_putsValue_andIgnoresBlank() {
        LogContext.setEntityId("notif-1");
        assertThat(MDC.get("entity_id")).isEqualTo("notif-1");
