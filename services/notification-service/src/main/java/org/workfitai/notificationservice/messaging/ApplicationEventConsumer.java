 ...
 *
 * Handles:
 * - APPLICATION_CREATED: Send emails to candidate and HR when a new application is submitted
 */
@Component
...
public class ApplicationEventConsumer {
    ...
    public void handleApplicationCreated(@Payload ApplicationCreatedEvent event, Acknowledgment ack) {
    ...
    private void sendCandidateConfirmationEmail(ApplicationCreatedEvent.ApplicationData data) {
        try {
            ...
            variables.put("candidateName", data.getCandidateName() != null ? data.getCandidateName() : data.getUsername());
