        ...
        public void run(String... args) {
                ...
                if (countJobs == 0) {
                        ...
                        for (int i = 1; i <= 30; i++) {
                                ...
                                ExperienceLevel expLevel = (i % 3 == 0) ? ExperienceLevel.JUNIOR
                                                : (i % 3 == 1) ? ExperienceLevel.MID : ExperienceLevel.SENIOR;
                                ...
                                String shortDesc = "Tuyển " + expLevel.name()
                                                + " Developer tham gia phát triển dự án hệ thống nội bộ.";

                                String benefits = "- Lương thưởng hấp dẫn\n" +
                                                "- Bảo hiểm full lương\n" +
                                                "- Cơ hội onsite quốc tế\n" +
                                                "- Môi trường chuyên nghiệp";

                                String requirements = "- Kinh nghiệm " + rand.nextInt(4) + "–" + (2 + rand.nextInt(3))
                                                + " năm\n" +
                                                "- Nắm vững cấu trúc dữ liệu và thuật toán\n" +
                                                "- Hiểu biết về hệ thống phân tán\n" +
                                                "- Kỹ năng teamwork tốt";

                                String responsibilities = "- Phát triển và bảo trì hệ thống\n" +
                                                "- Viết unit test\n" +
                                                "- Code review cho team\n" +
                                                "- Tối ưu hiệu năng module";

                                String requiredExperience = expLevel == ExperienceLevel.JUNIOR ? "0-1 năm"
                                                : expLevel == ExperienceLevel.MID ? "2-4 năm" : "5+ năm";
