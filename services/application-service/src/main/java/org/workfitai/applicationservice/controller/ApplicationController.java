 ...
 * Covers: submit, list own applications, view, withdraw, and check/history/public-notes.
 */
@RestController
...
public class ApplicationController {
    ...
    public ResponseEntity<RestResponse<ResultPaginationDTO<ApplicationResponse>>> getMyApplications(
        ...
        ResultPaginationDTO<ApplicationResponse> result = (status != null)
                ? applicationService.getMyApplicationsByStatus(username, status, pageable)
                : applicationService.getMyApplications(username, pageable);
    ...
    public ResponseEntity<RestResponse<Map<String, Long>>> getMyApplicationCount(
        ...
        String username = applicationSecurity.getCurrentUsername(authentication);
        return ResponseEntity.ok(RestResponse.success(Map.of("count", applicationService.countByUser(username))));
    }
